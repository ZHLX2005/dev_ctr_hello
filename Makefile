...
docker-restart: docker-down docker-up ## Restart Docker Compose service

.PHONY: server-start
server-start: docker-up ## Start file server
	@echo "File server started!"
	@echo "URL: http://localhost:8080"
	@echo "Health: http://localhost:8080/health"

.PHONY: clean-all
clean-all: clean ## Clean all files (including storage)
